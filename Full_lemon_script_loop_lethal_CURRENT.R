...
a_priori_abund <- 7 #For prior estimation - sets initial parameter values, so should match Estimated_truth value
iterations <- 500 #Set number of iterations to run in the loop

source("functions/get_P_lemon_lethal.R")
source("functions/lemon_neg_log_like_lethal.R")
...
##TROUBLESHOOT - below counts the number of juvs, fathers, and mothers for the whole dataset
