...
This script is the script I use for visualizing results. I work on the code here, and then transfer the relevant parts to a clean markdown doc for knitting.
...
#null model results
IBS.null_CNR <- Sys.glob("~/R/R_working_dir/LemonSharkCKMR_GitHub/02_IBS/fishSim_model_validation/results/*6_yrs_05.12.2021.csv")
...
head(IBS.null_results_CNR)
years_sampled <- 6

IBS.null_results_CNR <- IBS.null_results_CNR %>% mutate(Samples_per_year = Total_samples/years_sampled) %>% 
  mutate(Percent_sampled = (Samples_per_year/Pop_size_mean)*100)

NullIBS_Box <- ggplot(data=IBS.null_results_CNR, aes(x=factor(Total_samples))) +
  geom_boxplot(aes(y=Relative_bias, fill=Sex)) +
  ylim(-50, 160) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
  labs(x="Sample size", y="Relative bias", title="Relative bias fishSim sex-combined and sex-aggregated") +
  scale_fill_brewer(palette="Set2") +
  font("title", size = 10, face = "bold")

NullIBS_Scatter <- ggplot(data=IBS.null_results_CNR, aes(x=Percent_sampled)) +
  geom_jitter(aes(y=Relative_bias, color=Sex)) +
  ylim(-50, 100) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin = min(IBS.null_results_CNR$Percent_sampled), xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
  labs(x="Percent sampled", y="Relative bias", title="Relative bias fishSim sex-combined and sex-aggregated") +
  scale_fill_brewer(palette="Set2") +
  font("title", size = 10, face = "bold")

# NullIBS2 <- ggplot(data=IBS.null_results_2, aes(x=factor(Samples))) +
#   geom_boxplot(aes(y=Relative_bias, fill=Sex)) +
#   ylim(-50, 160) +
#   geom_hline(yintercept=0, col="black", size=1.25) +
#   annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
#   labs(x="Sample size", y="Relative bias", title="Relative bias of IBS Simulations") +
#   scale_fill_brewer(palette="Set2") +
#   font("title", size = 10, face = "bold")

head(IBS.null_demo, 10)
head(IBS.null_results_CNR)

ggarrange(NullIBS1, NullIBS2, common.legend = TRUE)
```
<br>
...
## 02/05/2021 - null model validation
#Assumes csv files have output from sex-specific and sex-aggregated results

#null model results
files_null_ages.correct <- Sys.glob("~/R/R_working_dir/CKMR/LemonSharkCKMR_GitHub/null/results/2021.02.10/*ages.correct.csv")
null_hs_correct <- sapply(files_null_ages.correct, read_csv, simplify=FALSE) %>% 
bind_rows() #%>% 
  #drop_na()

files_null_ages.mis.neutral <- Sys.glob("~/R/R_working_dir/CKMR/LemonSharkCKMR_GitHub/null/results/2021.02.10/*ages.misassigned.neutral.csv")
null_hs_mis.neutral <- sapply(files_null_ages.mis.neutral, read_csv, simplify=FALSE) %>% 
bind_rows() #%>% 
  #drop_na()

files_null_ages.mis.under <- Sys.glob("~/R/R_working_dir/CKMR/LemonSharkCKMR_GitHub/null/results/2021.02.10/*ages.misassigned.under.csv")
null_hs_mis.under <- sapply(files_null_ages.mis.under, read_csv, simplify=FALSE) %>% 
bind_rows() #%>% 
  #drop_na()

files_null_ages.mis.over <- Sys.glob("~/R/R_working_dir/CKMR/LemonSharkCKMR_GitHub/null/results/2021.02.10/*ages.misassigned.over.csv")
null_hs_mis.over <- sapply(files_null_ages.mis.over, read_csv, simplify=FALSE) %>% 
bind_rows() #%>% 
  #drop_na()


#fishSim results
files_fishSim_ages.correct <- Sys.glob("~/R/R_working_dir/CKMR/LemonSharkCKMR_GitHub/fishSim/results/2021.02.10/*ages.correct_fishSim.N.csv")
fs_hs_correct <- sapply(files_fishSim_ages.correct, read_csv, simplify=FALSE) %>% 
bind_rows() #%>% 
  #drop_na()

files_fishSim_ages.mis.neutral <- Sys.glob("~/R/R_working_dir/CKMR/LemonSharkCKMR_GitHub/fishSim/results/2021.02.05/*ages.neutral_fishSim.N.csv")
fs_hs_mis.neutral <- sapply(files_fishSim_ages.mis.neutral, read_csv, simplify=FALSE) %>% 
bind_rows() #%>% 
  #drop_na()

files_fishSim_ages.mis.over <- Sys.glob("~/R/R_working_dir/CKMR/LemonSharkCKMR_GitHub/fishSim/results/2021.02.05/*ages.over_fishSim.N.csv")
fs_hs_mis.over <- sapply(files_fishSim_ages.mis.over, read_csv, simplify=FALSE) %>% 
bind_rows() #%>% 
  #drop_na()


files_fishSim_ages.mis.under <- Sys.glob("~/R/R_working_dir/CKMR/LemonSharkCKMR_GitHub/fishSim/results/2021.02.05/*ages.under_fishSim.N.csv")
fs_hs_mis.under <- sapply(files_fishSim_ages.mis.under, read_csv, simplify=FALSE) %>% 
bind_rows() #%>% 
  #drop_na()
...
#Age distributions
files_age <- Sys.glob("~/R/R_working_dir/CKMR/LemonSharkCKMR_GitHub/fishSim_simulations/null_model_tests/results/2021.02.10/*age.dist.csv")
...
# files_surv <- Sys.glob("~/R/R_working_dir/CKMR/LemonSharkCKMR_GitHub/fishSim/results/2021.02.03/*surv.csv")
...
```{r Null box plots misassigned ages, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
NullBox1 <- ggplot(data=null_hs_correct, aes(x=factor(Samples))) +
  geom_boxplot(aes(y=Relative_bias, fill=Sex)) +
  ylim(-50, 160) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
...
NullBox2 <- ggplot(data=null_hs_mis.neutral, aes(x=factor(Samples))) +
  geom_boxplot(aes(y=Relative_bias, fill=Sex)) +
  ylim(-50, 160) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
  labs(x="Sample size", y="Relative bias", title="B) Relative Bias (Ages misassigned - neutral)") +
  scale_fill_brewer(palette="Set2") +
  font("title", size = 10, face = "bold")

NullBox3 <- ggplot(data=null_hs_mis.over, aes(x=factor(Samples))) +
  geom_boxplot(aes(y=Relative_bias, fill=Sex)) +
  ylim(-50, 160) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
  labs(x="Sample size", y="Relative bias", title="C) Relative Bias (Ages misassigned - over)") +
  scale_fill_brewer(palette="Set2") +
  font("title", size = 10, face = "bold")

NullBox4 <- ggplot(data=null_hs_mis.under, aes(x=factor(Samples))) +
  geom_boxplot(aes(y=Relative_bias, fill=Sex)) +
  ylim(-50, 160) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
  labs(x="Sample size", y="Relative bias", title="D) Relative Bias (Ages misassigned - under)") +
  scale_fill_brewer(palette="Set2") + 
  font("title", size = 10, face = "bold")
    #G + facet_wrap(~Pop_trend)
  
  ggarrange(NullBox1, NullBox2, NullBox3, NullBox4, common.legend = TRUE)  
```
  <font size=2> **Figure 1:** The goal here was to test how CKMR performs when ages are misassigned; however, this figure would instead appear to show how CKMR performs when a population's age structure is imperfectly sampled, which is difficult to disentangle from the former question without an individual-based simulation program. Results show that null CKMR models are mostly unbiased when data are simulated from the model, whether ages are correctly assigned or whether each sample is prone to deviate from the stable age distribution by +/- 3 years. Ages were assigned to sampled individuals probabilistically based on the stable age distribution of the population; then, ages were varied by +/-3 years before assigning kinship. Relative bias vs sample size when ages are **A)** correctly assigned, **B)** randomly misassigned up to +/-3 years, **C)** consistently misassigned to be up to 3 years older than they actually are, and **D)** consistently misassigned to be up to 3 years younder than they actually are. **Question: is this testing what we're trying to test?** </font>

<br>
<br>
<br>
```{r violin plots of misassigned ages, echo=FALSE, message=FALSE, warning=FALSE, results='hide', eval = FALSE}
#Violin plot
NullViol1 <- ggplot(data=null_hs_correct, aes(x=factor(Samples))) +
...
NullViol2 <- ggplot(data=null_hs_mis.neutral, aes(x=factor(Samples))) +
  geom_violin(aes(y=Relative_bias, fill=Sex)) +
  ylim(-100, 100) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
...
NullViol3 <- ggplot(data=null_hs_mis.over, aes(x=factor(Samples))) +
  geom_violin(aes(y=Relative_bias, fill=Sex)) +
  ylim(-100, 100) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
...
NullViol4 <- ggplot(data=null_hs_mis.under, aes(x=factor(Samples))) +
  geom_violin(aes(y=Relative_bias, fill=Sex)) +
  ylim(-100, 100) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
  ...
  ggarrange(NullViol1, NullViol2, NullViol3, NullViol4, common.legend = TRUE) 
  
#   <br>
#   <font size=2> **Figure 2:** Truncated violin plots show that the null CKMR models are unbiased when data are simulated from the model and ages are correcly assigned. As expected, precision increases with sample size. **A)** .</font><br>
# <br>
# <br>
``` 
...
null_hs_all <- rbind(null_hs_correct, null_hs_mis.neutral, null_hs_mis.over, null_hs_mis.under)

G3 <- ggplot(data=null_hs_all, aes(x=Parents_detected, color=Sex)) +
...
```  
<br>
<font size=2> **Figure 2:** Precision of CKMR abundance estimates increases as more samples are taken and as more kin are identified. When far fewer kin are observed than expected (left side of left graph), bias increases sharply. However, bias is generally <25% even if a population is oversampled and more kin than expected are found. These results underline the importance of unbiased (so the expected number of kin pairs are found) and robust (so the population is not undersampled) sampling when using CKMR. </font>
<br>
<br>
<br>
```{r fishSim test box plot and age structure, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
fishbox <- ggplot(data=fs_hs_correct) +
  geom_boxplot(aes(y=Relative_bias, fill=Sex), notch = FALSE) +
  ylim(-100, 100) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=-Inf, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
  labs(x="Sample size", y="Relative bias", title="A) Relative Bias of CKMR Estimates with fishSim") +
  scale_fill_brewer(palette="Set2") +
  font("title", size = 10, face = "bold") +
...
stable <- cbind(stable, c(1:31))
colnames(stable) <- c("proportion", "age")

age_struc <- ggplot(data=fs_ageT, aes(x=age, y = proportion)) +
  geom_line(aes(group = replicate)) +
  geom_line(data = stable, aes(x=age, y = proportion), color="red", size=2) +
  #ylim(0, .25) +
  labs(title="B) Age structure from fishSim")

ggarrange(fishbox, age_struc, nrow = 2)
```
<font size=2> **Figure 3:** **A)** CKMR estimates with fishSim remain positively biased. **B)** The age structure that arises from fishSim nearly matches the stable age structure for the parameters, but not quite. </font>
...
FishSim box plots and violin plots when ages are misassigned
```{r box plot and violin plot of bias by sample size and pop trend, echo=FALSE, message=FALSE, warning=FALSE, results='hide', eval=FALSE}
FishBox1 <- ggplot(data=fs_hs_correct, aes(x=factor(Samples))) +
  geom_boxplot(aes(y=Relative_bias, fill=Sex)) +
  ylim(-100, 100) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
...
FishBox2 <- ggplot(data=fs_hs_mis.neutral, aes(x=factor(Samples))) +
  geom_boxplot(aes(y=Relative_bias, fill=Sex)) +
  ylim(-100, 100) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
...
FishBox3 <- ggplot(data=fs_hs_mis.over, aes(x=factor(Samples))) +
  geom_boxplot(aes(y=Relative_bias, fill=Sex)) +
  ylim(-100, 100) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
...
FishBox4 <- ggplot(data=fs_hs_mis.under, aes(x=factor(Samples))) +
  geom_boxplot(aes(y=Relative_bias, fill=Sex)) +
  ylim(-100, 100) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
  ...
  ggarrange(FishBox1, FishBox2, FishBox3, FishBox4, common.legend = TRUE)  
  
        #Violin plot
FishViol1 <- ggplot(data=fs_hs_correct, aes(x=factor(Samples))) +
  geom_violin(aes(y=Relative_bias, fill=Sex)) +
  ylim(-100, 100) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
...
FishViol2 <- ggplot(data=fs_hs_mis.neutral, aes(x=factor(Samples))) +
  geom_violin(aes(y=Relative_bias, fill=Sex)) +
  ylim(-100, 100) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
...
FishViol3 <- ggplot(data=fs_hs_mis.over, aes(x=factor(Samples))) +
  geom_violin(aes(y=Relative_bias, fill=Sex)) +
  ylim(-100, 100) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
...
FishViol4 <- ggplot(data=fs_hs_mis.under, aes(x=factor(Samples))) +
  geom_violin(aes(y=Relative_bias, fill=Sex)) +
  ylim(-100, 100) +
  geom_hline(yintercept=0, col="black", size=1.25) +
  annotate("rect", xmin=0, xmax=Inf, ymin=-20, ymax=20, alpha=.5, col="red") +
  ...
  ggarrange(FishViol1, FishViol2, FishViol3, FishViol4, common.legend = TRUE) 
  

G_scat <- ggplot(data=fs_hs_correct, aes(x=Truth, color=Sex)) +
  geom_point(aes(y=Parents_detected)) +
  #ylim(-100, 100) +
  labs(x="Truth", y="Parents detected", title="Parents detected vs truth") +
  scale_colour_brewer(palette="Set2")

G_scat + facet_wrap(vars(Samples))
``` 
<br>
