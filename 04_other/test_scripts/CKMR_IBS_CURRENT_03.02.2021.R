...
nrow(full_sibs) #Check if there are fullsibs
...
write.table(results, file = paste0("~/R/R_working_dir/CKMR/LemonSharkCKMR_GitHub/fishSim_simulations/null_model_tests/results/Dovi.IBS_", total_samples, ".samples_02.26.2021_N.csv"), sep=",", dec=".", qmethod="double", row.names=FALSE)
