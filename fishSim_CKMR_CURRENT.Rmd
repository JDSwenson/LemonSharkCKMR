...
5/27/2020
Estimates and truth don't really match up at all ... Need to: 
1) run this in a loop - maybe just 100 iterations 
2) visualize results
3) double-check that truth count is accurate
4) look at function script
...
total_abundance <- c(rep(pop, times = n_yrs))
...
Half-sib data format
Construct positive kin dataframes for individual heterogeneity in fecundity
```{r}
