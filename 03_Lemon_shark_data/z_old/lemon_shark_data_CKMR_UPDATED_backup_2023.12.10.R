...
results %>% distinct(.keep_all = TRUE) %>% 
  write_csv(file = "G://My Drive/Personal_Drive/R/CKMR/output_peer_review/Model.results/lemon_shark_sims/LS_data_ConnModel_allSibs_2023.12.08.csv")

#Save final pairwise comparison matrices
saveRDS(mom.comps.tibble, file = "G://My Drive/Personal_Drive/R/CKMR/output_peer_review/Model.results/lemon_shark_sims/mom.comps_LS_data_ConnModel_allSibs_2023.12.08")

saveRDS(dad.comps.tibble, file = "G://My Drive/Personal_Drive/R/CKMR/output_peer_review/Model.results/lemon_shark_sims/dad.comps_LS_data_ConnModel_allSibs_2023.12.08")


#Save model output
saveRDS(post.samps_list.block3, file = "G://My Drive/Personal_Drive/R/CKMR/output_peer_review/Model.results/lemon_shark_sims/block3_model_results_allSibs_2023.12.08")

saveRDS(post.samps_list.block5, file = "G://My Drive/Personal_Drive/R/CKMR/output_peer_review/Model.results/lemon_shark_sims/block5_model_results_allSibs_2023.12.08")

saveRDS(post.samps_list.all, file = "G://My Drive/Personal_Drive/R/CKMR/output_peer_review/Model.results/lemon_shark_sims/all_model_results_allSibs_2023.12.08")
