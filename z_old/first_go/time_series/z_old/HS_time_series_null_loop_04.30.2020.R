...
source("./time_series/models/get_P_lemon_HS_time_series_REVISED.R")
...
Samples[,1]=rep(c(t_start:t_end),times=c(rep(n_samples_per_yr, 3),n_samples_per_yr)) #what year did I capture you? repeat each year for the number of samples that were taken.
