...
#-------------------Set up simulation----------------------------
script_name <- "HS.only_target.YOY_SimPsi1_0.05NonConform_informative.priors.R" #Copy name of script here
primary_goal <- "Figure out how the model performs with prior information regarding psi and survival when psi is set to 1 with 5% non-conformists." #Why am I running this simulation? Provide details
...
purpose <- "HS.only_target.YOY_SimPsi1_0.05NonConform_informative.priors" #For naming output files
