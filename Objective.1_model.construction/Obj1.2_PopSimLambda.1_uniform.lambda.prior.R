...
script_name <- "Obj1.2_PopSimLambda.1_uniform.lambda.prior.R" #Copy name of script here
...
question3 <- ""
purpose <- "Obj1.2_PopSimLambda.1_uniform.lambda.prior" #For naming output files
