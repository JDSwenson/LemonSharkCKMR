...
#-------------------Set up simulation----------------------------
script_name <- "HS.only_target.YOY_SB_new.pops_uninf.priors.R" #Copy name of script here
...
purpose <- "HS.only_target.YOY_SB_new.pops_uninf.priors" #For naming output files
