...
script_name <- "Obj1.2_PopSimLambda.variable_fixed.lambda.prior.R" #Copy name of script here
...
question3 <- ""
purpose <- "Obj1.2_PopSimLambda.variable_fixed.lambda.prior" #For naming output files
