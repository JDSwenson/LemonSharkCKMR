...
#-------------------Set up simulation----------------------------
script_name <- "HS.only_sample.all.ages_SB_new.pops_informative.priors_psi.surv.R" #Copy name of script here
primary_goal <- "Troubleshoot: figure out how the model performs with prior information regarding psi and survival." #Why am I running this simulation? Provide details
...
purpose <- "HS.only_sample.all.ages_SB_new.pops_informative.priors_psi.surv" #For naming output files
