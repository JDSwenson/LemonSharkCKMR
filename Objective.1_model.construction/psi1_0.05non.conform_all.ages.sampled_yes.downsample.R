...
#-------------------Set up simulation----------------------------
script_name <- "psi1_0.05non.conform_all.ages.sampled_yes.downsample.R" #Copy name of script here
...
question3 <- "How does sampling scheme affect model performance?"
purpose <- "psi1_0.05non.conform_all.ages.sampled_yes.downsample" #For naming output files
