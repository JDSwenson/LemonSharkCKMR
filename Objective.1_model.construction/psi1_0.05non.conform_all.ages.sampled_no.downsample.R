...
#-------------------Set up simulation----------------------------
script_name <- "psi1_0.05non.conform_all.ages.sampled_no.downsample.R" #Copy name of script here
...
purpose <- "psi1_0.05non.conform_all.ages.sampled_no.downsample" #For naming output files
