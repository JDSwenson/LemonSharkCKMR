...
#-------------------Set up simulation----------------------------
script_name <- "psi1_0.05non.conform_target.YOY_yes.downsample_informative.priors.R" #Copy name of script here
...
purpose <- "psi1_0.05non.conform_target.YOY_yes.downsample_informative.priors" #For naming output files
