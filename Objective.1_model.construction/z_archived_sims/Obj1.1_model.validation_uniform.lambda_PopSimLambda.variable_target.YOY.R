...
script_name <- "Obj1.1_model.validation_uniform.lambda_target.YOY.R" #Copy name of script here
...
purpose <- "Obj1.1_model.validation_uniform.lambda_target.YOY" #For naming output files
