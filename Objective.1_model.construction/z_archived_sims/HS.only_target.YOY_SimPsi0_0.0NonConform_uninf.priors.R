...
#-------------------Set up simulation----------------------------
script_name <- "HS.only_target.YOY_SimPsi0_0.0NonConform_uninf.priors.R" #Copy name of script here
...
purpose <- "HS.only_target.YOY_SimPsi0_0.0NonConform_uninf.priors" #For naming output files
