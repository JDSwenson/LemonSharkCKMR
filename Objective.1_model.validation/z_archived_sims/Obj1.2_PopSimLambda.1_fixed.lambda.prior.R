...
script_name <- "Obj1.2_PopSimLambda.1_fixed.lambda.prior.R" #Copy name of script here
...
question2 <- "How do the diffuse prior results compare to the informed prior results?"
question3 <- ""
purpose <- "Obj1.2_PopSimLambda.1_fixed.lambda.prior" #For naming output files
...
# 
   ...
   saveRDS(sims.list.1, file = paste0(temp_location, MCMC_prefix, "_", date.of.simulation, "_", outSeeds, "_", sim.samples, "_", MCMC.settings, "_", purpose, "_0.95_fixed.lambda"))
   # 
   saveRDS(sims.list.2, file = paste0(temp_location, MCMC_prefix, "_", date.of.simulation, "_", outSeeds, "_", sim.samples, "_", MCMC.settings, "_", purpose, "_1.0_fixed.lambda"))
   # 
   saveRDS(sims.list.3, file = paste0(temp_location, MCMC_prefix, "_", date.of.simulation, "_", outSeeds, "_", sim.samples, "_", MCMC.settings, "_", purpose, "_1.05_fixed.lambda"))
   # 
...
write.table(results2, file = paste0(results_location, results_prefix, "_", date.of.simulation, "_", outSeeds, "_", purpose, ".csv"), sep=",", dec=".", qmethod="double", row.names=FALSE)
 ...
 saveRDS(sims.list.1, file = paste0(MCMC_location, MCMC_prefix, "_", date.of.simulation, "_", outSeeds, "_", sim.samples, "_", MCMC.settings, "_", purpose, "_0.95_fixed.lambda")) #Lambda fixed 1
 
 saveRDS(sims.list.2, file = paste0(MCMC_location, MCMC_prefix, "_", date.of.simulation, "_", outSeeds, "_", sim.samples, "_", MCMC.settings, "_", purpose, "_1.0_fixed.lambda")) #Lambda fixed 2
 
 saveRDS(sims.list.3, file = paste0(MCMC_location, MCMC_prefix, "_", date.of.simulation, "_", outSeeds, "_", sim.samples, "_", MCMC.settings, "_", purpose, "_1.05_fixed.lambda")) #Lambda fixed 3
