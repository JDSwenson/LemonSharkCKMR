...
ggsave("Figure_1ALL_2022.11.29.tiff", plot = last_plot(), device = "tiff", dpi = 300, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/", width = 3694, height = 1894, units = "px")
...
ggsave("Figure_5_2022.11.29.tiff", plot = last_plot(), device = "tiff", dpi = 300, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")

#----------------------Figure S7----------------------------
figS7 <- ls_data %>% dplyr::filter(years_sampled %in% c(2, 3, 4, 5, 6, 7), parameter == "survival") %>% dplyr::mutate(years_sampled_actual = years_sampled + 1) %>%
  mutate(years.lab = paste0(years_sampled_actual, " years sampled"),
         year.est = ceiling(min.year + years_sampled/2)) %>% 
  ggplot(aes(x = year.est, y = Q50)) + 
  geom_point() + 
...
ggsave("Figure_S7_2022.11.29.tiff", plot = last_plot(), device = "tiff", dpi = 300, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")
