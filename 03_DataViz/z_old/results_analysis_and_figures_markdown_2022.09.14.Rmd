...
objective_3_MCMC_location <- "G://My Drive/Personal_Drive/R/CKMR/Objective.3_intermittent.breeding/Pre_Nov2022/Model.output/"
objective_3_results_location <- "G://My Drive/Personal_Drive/R/CKMR/Objective.3_intermittent.breeding/Pre_Nov2022/Model.results/"
objective_3_results_plots_location <- "G://My Drive/Personal_Drive/R/CKMR/Objective.3_intermittent.breeding/Pre_Nov2022/Model.results/figures/"

objective_4_MCMC_location <- "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Pre_Nov2022/Model.output/"
objective_4_results_location <- "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Pre_Nov2022/Model.results/"
objective_4_results_plots_location <- "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Pre_Nov2022/Model.results/figures/"
...
fig3a <- obj3_results.liz %>% dplyr::filter(sim.psi == 1, 
  ...
  ggplot(aes(x = factor(parameter), y = percent_in_interval, group = sampling.scheme)) + 
  geom_point(size = 4, shape = 22, aes(color = "black", 
                           fill = sampling.scheme)) +
...
#ggsave("Figure_3a_2022.10.10.tiff", plot = last_plot(), device = "tiff", dpi = 300, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")
