#THIS IS THE MOST RECENT SCRIPT 05/04/2020

##NEXT: pick up at line 114: May not need to sample the population, but could instead use the whole population
