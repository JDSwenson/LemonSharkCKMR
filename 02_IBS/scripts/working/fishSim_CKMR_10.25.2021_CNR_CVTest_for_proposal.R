...
t_start = 44 #First year we take samples
...
results <- results %>% 
  ...
  write.table(results, file = paste0("~/R/R_working_dir/LemonSharkCKMR_GitHub/02_IBS/fishSim_model_validation/Cownose_Rays/fishSim_AvgN_", n_samples_total, "_samples_sex-specific_and_aggregated_loop_6_yrs_CNR_05.14.2021.csv"), sep=",", dec=".", qmethod="double", row.names=FALSE)
}
