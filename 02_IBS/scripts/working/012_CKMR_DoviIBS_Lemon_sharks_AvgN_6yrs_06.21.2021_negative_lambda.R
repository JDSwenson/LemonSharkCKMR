...
### NO MORE WARNINGS
    ...
    colnames(metrics) <- c("Parents_detected", "Pop_growth", "Total_samples", "Pop_size_mean", "convergence", "kkt1", "kkt2")
...
#
write.table(results2, file = paste0("/home/js16a/R/working_directory/CKMR_simulationsDovi_AvgN_negative_lambda_06_21.2021.csv"), sep=",", dec=".", qmethod="double", row.names=FALSE)
