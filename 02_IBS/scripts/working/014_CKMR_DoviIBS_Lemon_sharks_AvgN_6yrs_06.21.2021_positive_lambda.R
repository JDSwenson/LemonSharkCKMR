...
#
write.table(results2, file = paste0("/home/js16a/R/working_directory/CKMR_simulationsDovi_AvgN_positive_lambda_06_21.2021.csv"), sep=",", dec=".", qmethod="double", row.names=FALSE)
