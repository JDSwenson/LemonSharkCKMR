...
for(iter in 1:iterations) {
  ...
  for(samps in 1:3){
    ...
    jags_file = paste0("~/R/working_directory/LemonSharkCKMR/02_IBS/Dovi_IBS_model_validation/Lemon_sharks/results/basic_bayesian/models/HS_negGrowth_model_iteration_", iter, ".txt")
  ...
  write.table(results, file = paste0("~/R/working_directory/LemonSharkCKMR/02_IBS/Dovi_IBS_model_validation/Lemon_sharks/results/basic_bayesian/simple_model_negGrowth_iteration", iter, ".csv"), sep=",", dec=".", qmethod="double", row.names=FALSE)
...
write.table(results2, file = paste0("~/R/working_directory/LemonSharkCKMR/02_IBS/Dovi_IBS_model_validation/Lemon_sharks/results/basic_bayesian/simple_model_validation_negGrowth.csv"), sep=",", dec=".", qmethod="double", row.names=FALSE)
