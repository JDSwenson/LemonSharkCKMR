...
#Home computer
write.table(results2, file = paste0("~/R/R_working_dir/LemonSharkCKMR_GitHub/02_IBS/Dovi_IBS_model_validation/Lemon_sharks/results/skipped_breedingg/Dovi_neutral_lambda_SB_NM_07.06.2021.csv"), sep=",", dec=".", qmethod="double", row.names=FALSE)
