...
num.mates <- 1 # vector of potential number of mates per mating
...
write.table(results, file = paste0("~/R/R_working_dir/LemonSharkCKMR_GitHub/02_IBS/Dovi_IBS_model_validation/Cownose_rays/results/length_of_sampling/six_year_sampling/Dovi_AvgN_", total_samples, "_samples_05.25.2021_",length(sample.years), "yrs.csv"), sep=",", dec=".", qmethod="double", row.names=FALSE)
