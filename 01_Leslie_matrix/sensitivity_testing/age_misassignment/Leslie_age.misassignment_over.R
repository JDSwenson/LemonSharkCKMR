...
Samples <- c() 
  ...
  mis_vec <- c(seq(0, 3, by=1)) #misassignment of ages
...
#  results$Relative_bias <- round(((results$N_est - results$Truth)/results$Truth)*100,1)
  ...
  write.table(results, file = paste0("/home/js16a/R/working_directory/CKMR_simulations/results/Leslie.null_", n_samples, ".samples_02.10.2021_ages.misassigned.over.csv"), sep=",", dec=".", qmethod="double", row.names=FALSE)
}