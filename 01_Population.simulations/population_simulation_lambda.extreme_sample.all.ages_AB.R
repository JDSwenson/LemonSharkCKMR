...
source("./01_Population.simulations/functions/Dovi_IBS_AB_extreme.lambda.R")
...
script_name <- "population_simulation_lambda.extreme_sample.all.ages_AB.R" #Copy name of script here
...
#set.seed(rseed.pop)
 ...
 for(iter in 1:iterations) {
  ...
  for(samps in 1:length(sample.vec.prop)){
    ...
    source("01_Population.simulations/functions/PopSim_truth_extreme.lambda.R")
