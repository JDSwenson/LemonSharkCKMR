...
```{r visualize prior and posterior}
...
HPDI.file <- paste0(results_plots_location, "HPDI_linePlot_", date.of.simulation, "_", seeds, "_", purpose, "_", "allSampleSizes.pdf")

HPDI.plot <- ggarrange(Nf.HPDI.plot, Nm.HPDI.plot, surv.HPDI.plot, lam.HPDI.plot, common.legend = TRUE) %>% 
  annotate_figure(top = text_grob(purpose, size = 18, face = "bold"))

ggsave(filename = HPDI.file, plot = HPDI.plot, device = "pdf")
```
