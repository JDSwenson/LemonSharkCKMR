...
mc <- mom_comps.gap %>% mutate(all.adj = all * (Adult.survival^yr_gap)) %>% #could add 0.5 for skipped breeding, but not sure that's necessary, since the year gap is always 2 ...
