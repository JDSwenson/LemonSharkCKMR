---
title: "CKMR simulation results: 100% biennial female breeders"
output: 
  html_document:
    df_print: tibble
    toc: true
...
date.of.simulation1 <- "04May2022"
purpose1 <- "HS.only_target.YOY_SB_new.pops_uninf.priors"
purpose1.lab <- "Targeted sampling - uninformative priors on survival and psi"
model.type1 <- "HS.only"

date.of.simulation2 <- "04May2022"
purpose2 <- "HS.only_target.YOY_SB_new.pops_informative.priors_psi.surv"
purpose2.lab <- "Targeted sampling - informed prior on survival; psi fixed"
model.type2 <- "HS.only"

date.of.simulation3 <- "04May2022"
purpose3 <- "HS.only_sample.all.ages_SB_new.pops_uninf.priors"
purpose3.lab <- "All ages sampled - uninformative priors on survival and psi"
model.type3 <- "HS.only"

date.of.simulation4 <- "04May2022"
purpose4 <- "HS.only_sample.all.ages_SB_new.pops_informative.priors_psi.surv"
...
## Background info
One hundred different populations were simulated where 100% of females in the population bred biennially.  
