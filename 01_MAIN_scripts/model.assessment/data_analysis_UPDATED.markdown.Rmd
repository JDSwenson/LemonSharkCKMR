...
HPDI.plot.list <- list(p.Nfb, p.psi, p.Nm, p.surv)
...
(HPDI.plots.N <- ggarrange(p.Nfb, p.Nm, p2.Nfb, p2.Nm, ncol = 2, nrow = 2, common.legend = TRUE, legend = "bottom"))
...
RelBias.Density.Plots.N <- ggarrange(p2.Nfb, p2.Nm, common.legend = TRUE, ncol = 1, nrow = 2, legend = "none")


#RelBias.Density.Plots <- ggarrange(p2.Nfb, p2.Nm, p2.surv, p2.lam, common.legend = TRUE, ncol = 2, nrow = 2, legend = "bottom")

#annotate_figure(p = N_Bias.HPDI.plots, fig.lab = "A)", fig.lab.pos = "top.left", fig.lab.size = 18, fig.lab.face = "bold")

```

```{r print figures}
#Male and female HPDI and relative bias for low and high sample sizes
ggarrange(HPDI.plots.N, RelBias.Density.Plots.N, common.legend = TRUE, ncol = 2)

#Survival HPDI and relative bias for all four sample sizes
Surv.plots <- ggarrange(p.surv, p2.surv, common.legend = TRUE, nrow = 2, legend = "bottom")
```
...
(Nf_HSPs <- results.all %>% dplyr::filter(parameter == "Nfa") %>% 
