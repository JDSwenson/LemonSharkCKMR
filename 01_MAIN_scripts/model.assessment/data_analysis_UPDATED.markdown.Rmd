...
purpose.combo <- "Examine_model_performance_when_psi_is_set_at_birth_plus_downsample" #What am I comparing right now? This will be used to name output files
...
purpose1 <- "psi1_0.05non.conform_target.YOY_yes.downsample"
purpose1.lab <- "Target YOY | diffuse priors"
model.type1 <- "HS.only"

date.of.simulation2 <- "16May2022"
purpose2 <- "psi1_0.05non.conform_target.YOY_yes.downsample_informative.priors"
purpose2.lab <- "Target YOY | informed priors"
model.type2 <- "HS.only"

date.of.simulation3 <- "16May2022"
purpose3 <- "psi1_0.05non.conform_all.ages.sampled_yes.downsample"
