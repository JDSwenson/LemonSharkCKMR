...
ggarrange(fig1.p.Nf, fig1.p.Nm, fig1.p2.Nf, fig1.p2.Nm, common.legend = TRUE, nrow = 2, ncol = 2, legend = "none")
```
...
#Survival HPDI and relative bias for all four sample sizes
ggarrange(Fig2.p.Nf, Fig2.p2.Nf, Fig2.p.Nm, Fig2.p2.Nm, Fig2.p.surv, Fig2.p2.surv, common.legend = TRUE, nrow = 4, ncol = 2, legend = "bottom")
```
\
\
----------------------------------------------------------------------------------------------
...
```{r FigS1-print-plot2, echo=FALSE, out.width = "120%", fig.cap = "**Figure S1:** Model performance with diffuse priors with an increasing or declining population."}
figS1.p.violin
```
\
\
