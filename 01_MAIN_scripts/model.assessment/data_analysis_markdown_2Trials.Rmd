...
date.of.simulation1 <- "29Jun2022"
purpose1 <- "Obj1.2_PopSimLambda.1_uniform.lambda.prior"
purpose1.lab <- "Target YOY | PopSimLambda 1 | Uniform lambda"
model.type1 <- "HS.only"

date.of.simulation2 <- "29Jun2022"
purpose2 <- "Obj1.2_PopSimLambda.variable_uniform.lambda.prior"
purpose2.lab <- "All ages sampled | PopSimLambda variable | Uniform lambda"
model.type2 <- "HS.only"
...
results.all$purpose.lab <- factor(results.all$purpose.lab, levels = c(purpose1.lab, purpose2.lab))
...
-------------------------------------------------------------------------------------------
Main reason to run this script is to generate the files above


```{r other data analysis code}
