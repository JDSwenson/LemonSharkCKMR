...
head(results.all)
#results.all$purpose <- factor(results.all$purpose, levels = c("5yr.comps", "10yr.comps", "24yr.comps", "all.comps"))
...
DensityPlots.file <- paste0(results_plots_location, "Density_plots_", today, ".pdf") #Name file
...
boxPlots.file <- paste0(results_plots_location, "BoxPlots_", today, ".pdf") #Name output file
...
all.200.4viz$purpose <- factor(all.200.4viz$purpose, levels = c("5yr.comps", "10yr.comps", "24yr.comps", "all.comps"))

all.600.4viz <- HPD.600.1.4viz %>% bind_rows(HPD.600.2.4viz, HPD.600.3.4viz, HPD.600.4.4viz)
all.600.4viz$purpose <- factor(all.600.4viz$purpose, levels = c("5yr.comps", "10yr.comps", "24yr.comps", "all.comps"))

all.1000.4viz <- HPD.1000.1.4viz %>% bind_rows(HPD.1000.2.4viz, HPD.1000.3.4viz, HPD.1000.4.4viz)
all.1000.4viz$purpose <- factor(all.1000.4viz$purpose, levels = c("5yr.comps", "10yr.comps", "24yr.comps", "all.comps"))
...
#Specify file
KinPairs.file <- paste0(results_plots_location, "Distribution_of_kin_", today, ".pdf")
