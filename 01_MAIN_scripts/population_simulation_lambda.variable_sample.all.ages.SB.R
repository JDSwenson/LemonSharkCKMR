...
script_name <- "population_simulation_lambda.variable_sample.all.ages.R" #Copy name of script here
...
#Save simulation settings in Simulation_log
  ...
  # write_csv(pop.sim.df, file = "Population_simulation_log.csv") #Save the updated simulation log
