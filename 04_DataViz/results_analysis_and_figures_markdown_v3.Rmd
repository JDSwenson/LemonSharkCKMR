...
#Add labels for naive and adapted; CHANGE Nft and Nmt to Nf and Nm for consistency across scenarios; remove columns containing "expected" values for HSPs and POPs (comes from a vestigial function in the simulation scripts)
results.raw <- results.raw %>% mutate(model = ifelse(scenario %in% naive_scenarios, "naive", "adapted")) %>% 
  ...
  dplyr::select(-c(HSPs_expected, POPs_expected))
...
ggsave("SuppFig_aunt.niece_2023.10.31.tiff", plot = last_plot(), device = "tiff", dpi = 300, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/", width = 15, height = 12)
...
ggsave("SuppFig2_FullSibs_2023.10.31.tiff", plot = last_plot(), device = "tiff", dpi = 300, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw", width = 3694, height = 2200, units = "px")
```
...
ggsave("Figure_3a_2023.10.28.tiff", plot = last_plot(), device = "tiff", dpi = 300, width = 15, height = 12, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")
...
#Save each plot for Obj2 individually and combine in Affinity Designer
ggsave("SuppFig_age.dist_Obj2_2023.10.31.tiff", plot = last_plot(), device = "tiff", dpi = 300, width = 15, height = 6, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")
cp <- brewer.pal(3, "Set2") #Choose palette + number of colors
...
ggsave("Fig3e_lambda_Obj2_2023.10.31.tiff", plot = last_plot(), device = "tiff", dpi = 300, width = 15, height = 6, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")
...
#Save each plot for Obj2 individually and combine in Affinity Designer
ggsave("SuppFig3a_StablePop_Nf_Obj2.tiff", plot = last_plot(), device = "tiff", dpi = 300, width = 12, height = 8, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")
...
ggsave("SuppFig3b_survival_Obj2_2023.10.28.tiff", plot = last_plot(), device = "tiff", dpi = 300, width = 12, height = 5, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")
...
ggsave("Figure_4_Obj3_2023.10.28.tiff", plot = last_plot(), device = "tiff", dpi = 300, width = 14, height = 6, units = "in", path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")
...
ls_dataSim_allSibs <- read_csv(file = paste0(results_location, "lemon_shark_sims/lemon_shark_time_series_sims_results_Conn5_allSibs.csv")) %>%
...
ls_dataTrend_allSibs <- readRDS(file = paste0(results_location, "lemon_shark_sims/lemon_shark_time_series_sims_popsize_Conn5_allSibs"))
...
#----------------------Load population size for trajectory
ls_dataTrend_filterSibs <- readRDS(file = paste0(results_location, "lemon_shark_sims/lemon_shark_time_series_sims_popsize_Conn5_filterSibs"))
...
#--------------------All sibs -------------------------------
#----------------Keep all samples
ls_data_allSibs <- read_csv(file = "G://My Drive/Personal_Drive/R/CKMR/output_peer_review/Model.results/lemon_shark_sims/LS_data_ConnModel_AllSibs_2023.10.08.csv") %>%
...
#----------------Downsample
ls_data.Down_allSibs <- read_csv(file = "G://My Drive/Personal_Drive/R/CKMR/output_peer_review/Model.results/lemon_shark_sims/LS_data_ConnModel_AllSibsDown_2023.10.29.csv") %>%
...
ls_data_filterSibs <- read_csv(file = "G://My Drive/Personal_Drive/R/CKMR/output_peer_review/Model.results/lemon_shark_sims/LS_data_ConnModel_filterSibs_2023.10.05.csv") %>%
 #mutate(num.samps = num.samps_all) %>%
 #dplyr::select(-c(num.samps_all)) %>%
 dplyr::filter(estimation.year >= 1997) %>%
 mutate(time_window = ifelse(time_window == "all available samples" ,"all available samples",
...
ls_data.Down_filterSibs <- read_csv(file = "G://My Drive/Personal_Drive/R/CKMR/output_peer_review/Model.results/lemon_shark_sims/LS_data_ConnModel_filterSibsDown_2023.10.29.csv") %>%
  mutate(mom_HSPs = mom_HSPs.down,
         num.samps = num.samps_down) %>%
  dplyr::select(-c(mom_HSPs.down, num.samps_down)) %>%
  dplyr::filter(estimation_year >= 1997) %>%
...
# #Use these dfs to get numbers for a table
 ...
 ls_data.Down4viz_allSibs %>% dplyr::filter(parameter == "Nfbt", 
                                            time_window == "all available samples") %>% dplyr::select(time_window, estimation.year, mean_MHSPs) %>% 
   print(n = 20)
...
ls_Nfb_boxplot_allSibs <- ls_dataSim_allSibs %>% dplyr::filter(parameter %in% c("Nfbt")) %>% 
  ggplot() +
...
ggsave("Fig6_LS_sim_allSibs_boxplots_2023.10.28.tiff", plot = last_plot(), device = "tiff", dpi = 300, width = 15, height = 10, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")
...
ggsave("SuppFig8_LS_sim_Nfb_allSibs_singleTrend_2023.10.28.tiff", plot = last_plot(), device = "tiff", dpi = 300, width = 15, height = 8, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")



#------- Filter sibs -----------------------------------
#------- Box plot of relative bias for Nfb----------------#
ls_Nfb_boxplot_filterSibs <- ls_dataSim_filterSibs %>% dplyr::filter(parameter %in% c("Nfbt")) %>% 
  ggplot() +
  geom_boxplot(aes(x=factor(estimation.year), 
                   fill = time_window, 
                   y=relative_bias), 
...
ggsave("Fig6_LS_sim_filterSibs_boxplots_2023.10.28.tiff", plot = last_plot(), device = "tiff", dpi = 300, width = 15, height = 10, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")
...
ggsave("SuppFig8_LS_sim_Nfb_filterSibs_singleTrend_2023.10.28.tiff", plot = last_plot(), device = "tiff", dpi = 300, width = 15, height = 8, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")
...
ggsave("Fig6_LS_data_allSibs_Nfb_trend_2023.10.28.tiff", plot = last_plot(), device = "tiff", dpi = 300, width = 15, height = 4, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")
...
ggsave("SuppFig7_LS_data_allSibs_survival_2023.10.28.tiff", plot = last_plot(), device = "tiff", dpi = 300, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")



#----------Filter sibs; keep all samples
fig5a_filterSibs <- ls_data_filterSibs %>% 
  dplyr::filter(parameter == "Nfbt") %>%
  ggplot(aes(x = estimation.year, y = Q50, color = time_window)) + 
  #geom_point() + 
  geom_pointrange(aes(ymin = HPD2.5, ymax = HPD97.5),
...
ggsave("Fig6_LS_data_filterSibs_Nfb_trend_2023.10.28.tiff", plot = last_plot(), device = "tiff", dpi = 300, width = 15, height = 4, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")
...
ggsave("SuppFig7_LS_data_filterSibs_survival_2023.10.28.tiff", plot = last_plot(), device = "tiff", dpi = 300, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/")
...
ggsave("SuppFig7_LSData_Down_allSibs_2023.10.31.tiff", plot = last_plot(), device = "tiff", dpi = 300, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/", width = 12, height = 6, units = "in")
...
ggsave("SuppFig7_LSData_Down_filterSibs_2023.10.31.tiff", plot = last_plot(), device = "tiff", dpi = 300, path = "G://My Drive/Personal_Drive/R/CKMR/manuscript.figs/raw/", width = 12, height = 6, units = "in")
