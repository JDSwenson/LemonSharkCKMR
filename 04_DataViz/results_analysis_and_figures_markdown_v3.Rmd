...
ls_dataSim_allSibs <- read_csv(file = paste0(results_location, "lemon_shark_sims/peer_review_rd2/lemon_shark_time_series_sims_results_Conn5_allSibs_temp.csv")) %>%
...
ls_dataTrend_allSibs <- readRDS(file = paste0(results_location, "lemon_shark_sims/peer_review_rd2/lemon_shark_time_series_sims_popsize_Conn5_allSibs_temp"))
...
ls_dataSim_filterSibs <- read_csv(file = paste0(results_location, "/lemon_shark_sims/peer_review_rd2/lemon_shark_time_series_sims_results_Conn5_filterSibs_temp.csv")) %>%
  mutate(time_window = ifelse(time_window == "all available samples" ,"all available samples",
                              ifelse(time_window == "three year block", "three year window",
                                     ifelse(time_window == "five year block", "five year window", NA)))) %>% 
  mutate(iterID = paste0(T0, "_", iteration, "_", time_window))
...
#----------------------Load population size for trajectory-----------------
ls_dataTrend_filterSibs <- readRDS(file = paste0(results_location, "lemon_shark_sims/peer_review_rd2/lemon_shark_time_series_sims_popsize_Conn5_filterSibs_temp"))
...
#--------------------All sibs -------------------------------
#----------------Keep all samples
ls_data_allSibs <- read_csv(file = "G://My Drive/Personal_Drive/R/CKMR/output_peer_review/Model.results/lemon_shark_sims/LS_data_ConnModel_allsibs_2023.12.08.csv") %>%
...
#  ggtitle("a)") +
  ...
  ggtitle("d) Nfb - calculate; constrain psi")
...
#  ggtitle("a)") +
  ...
  scale_x_continuous(breaks = x.ticks,
                     labels = x.tick.labels) +
  ggtitle("Survival - constrain psi")
