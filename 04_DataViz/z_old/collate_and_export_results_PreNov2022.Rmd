...
objective_3_MCMC_location <- "G://My Drive/Personal_Drive/R/CKMR/Objective.3_intermittent.breeding/Nov_2022/Model.output/"
objective_3_results_location <- "G://My Drive/Personal_Drive/R/CKMR/Objective.3_intermittent.breeding/Nov_2022/Model.results/"
objective_3_results_plots_location <- "G://My Drive/Personal_Drive/R/CKMR/Objective.3_intermittent.breeding/Nov_2022/Model.results/figures/"

objective_4_MCMC_location <- "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Nov_2022/Model.output/"
objective_4_results_location <- "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Nov_2022/Model.results/"
objective_4_results_plots_location <- "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Nov_2022/Model.results/figures/"
...
#--------------------- Liz's model ---------------------------------
#Objective 3.2
scenario_3.2.1_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
...
scenario_3.2.2_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
...
scenario_3.2.3_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
...
#Read in files
scenario_3.2.1_results.liz <- map_dfr(scenario_3.2.1_files, read_csv) %>% 
...
scenario_3.2.2_results.liz <- map_dfr(scenario_3.2.2_files, read_csv) %>% 
  mutate(sampling.scheme = ifelse(purpose %in% purpose.obj3.2Y, "target YOY",
                                  ifelse(purpose %in% purpose.obj3.2J, "sample all juvenile ages",
                                         "sample all ages")),
         survival.prior = "diffuse",
...
scenario_3.2.3_results.liz <- map_dfr(scenario_3.2.3_files, read_csv) %>% 
  mutate(sampling.scheme = ifelse(purpose %in% purpose.obj3.2Y, "target YOY",
                                  ifelse(purpose %in% purpose.obj3.2J, "sample all juvenile ages",
                                         "sample all ages")),
         survival.prior = "diffuse",
...
scenario_3.2_results.all_liz <- bind_rows(scenario_3.2.1_results.liz, scenario_3.2.2_results.liz, scenario_3.2.3_results.liz)


#Objective 3.3
scenario_3.3.1_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
...
scenario_3.3.2_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
...
scenario_3.3.3_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
...
scenario_3.3_results.all_liz <- bind_rows(scenario_3.3.1_results.liz, scenario_3.3.2_results.liz, scenario_3.3.3_results.liz)

#Objective 3.4
scenario_3.4.1_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
                            pattern = "*scenario_3.4.1_*",
                            full.names = TRUE)

scenario_3.4.1_files

scenario_3.4.2_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
                            pattern = "*scenario_3.4.2_*",
                            full.names = TRUE)

scenario_3.4.2_files

scenario_3.4.3_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
                            pattern = "*scenario_3.4.3_*",
                            full.names = TRUE)

scenario_3.4.3_files


#Read in files
scenario_3.4.1_results.liz <- map_dfr(scenario_3.4.1_files, read_csv) %>% 
  mutate(sampling.scheme = ifelse(purpose %in% purpose.obj3.4Y, "target YOY",
                                  ifelse(purpose %in% purpose.obj3.4J, "sample all juvenile ages",
                                         "sample all ages")),
         survival.prior = "diffuse",
         lambda.prior = "none",
         psi.prior = "uniform",
...
scenario_3.4.2_results.liz <- map_dfr(scenario_3.4.2_files, read_csv) %>% 
  mutate(sampling.scheme = ifelse(purpose %in% purpose.obj3.4Y, "target YOY",
                                  ifelse(purpose %in% purpose.obj3.4J, "sample all juvenile ages",
                                         "sample all ages")),
         survival.prior = "diffuse",
...
scenario_3.4.3_results.liz <- map_dfr(scenario_3.4.3_files, read_csv) %>% 
  mutate(sampling.scheme = ifelse(purpose %in% purpose.obj3.4Y, "target YOY",
                                  ifelse(purpose %in% purpose.obj3.4J, "sample all juvenile ages",
                                         "sample all ages")),
         survival.prior = "diffuse",
...
scenario_3.4_results.all_liz <- bind_rows(scenario_3.4.1_results.liz, scenario_3.4.2_results.liz, scenario_3.4.3_results.liz)

#Objective 3.5
scenario_3.5.1_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
                            pattern = "*scenario_3.5.1_*",
                            full.names = TRUE)

scenario_3.5.1_files

scenario_3.5.2_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
                            pattern = "*scenario_3.5.2_*",
                            full.names = TRUE)

scenario_3.5.2_files

scenario_3.5.3_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
                            pattern = "*scenario_3.5.3_*",
                            full.names = TRUE)

scenario_3.5.3_files


#Read in files
scenario_3.5.1_results.liz <- map_dfr(scenario_3.5.1_files, read_csv) %>% 
  mutate(sampling.scheme = ifelse(purpose %in% purpose.obj3.5Y, "target YOY",
                                  ifelse(purpose %in% purpose.obj3.5J, "sample all juvenile ages",
                                         "sample all ages")),
         survival.prior = "diffuse",
         lambda.prior = "none",
         psi.prior = "uniform",
...
scenario_3.5.2_results.liz <- map_dfr(scenario_3.5.2_files, read_csv) %>% 
  mutate(sampling.scheme = ifelse(purpose %in% purpose.obj3.5Y, "target YOY",
                                  ifelse(purpose %in% purpose.obj3.5J, "sample all juvenile ages",
                                         "sample all ages")),
         survival.prior = "diffuse",
...
scenario_3.5.3_results.liz <- map_dfr(scenario_3.5.3_files, read_csv) %>% 
  mutate(sampling.scheme = ifelse(purpose %in% purpose.obj3.5Y, "target YOY",
                                  ifelse(purpose %in% purpose.obj3.5J, "sample all juvenile ages",
                                         "sample all ages")),
         survival.prior = "diffuse",
...
scenario_3.5_results.all_liz <- bind_rows(scenario_3.5.1_results.liz, scenario_3.5.2_results.liz, scenario_3.5.3_results.liz)

#Objective 3.6
scenario_3.6.1_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
                            pattern = "*scenario_3.6.1_*",
                            full.names = TRUE)

scenario_3.6.1_files

scenario_3.6.2_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
                            pattern = "*scenario_3.6.2_*",
                            full.names = TRUE)

scenario_3.6.2_files

scenario_3.6.3_files <- list.files(path = paste0(objective_3_results_location, "Liz_model/"),
                            recursive = FALSE,
                            pattern = "*scenario_3.6.3_*",
                            full.names = TRUE)

scenario_3.6.3_files


#Read in files
scenario_3.6.1_results.liz <- map_dfr(scenario_3.6.1_files, read_csv) %>% 
  mutate(sampling.scheme = ifelse(purpose %in% purpose.obj3.6Y, "target YOY",
                                  ifelse(purpose %in% purpose.obj3.6J, "sample all juvenile ages",
                                         "sample all ages")),
         survival.prior = "diffuse",
         lambda.prior = "none",
         psi.prior = "fixed",
...
scenario_3.6.2_results.liz <- map_dfr(scenario_3.6.2_files, read_csv) %>% 
  mutate(sampling.scheme = ifelse(purpose %in% purpose.obj3.6Y, "target YOY",
                                  ifelse(purpose %in% purpose.obj3.6J, "sample all juvenile ages",
                                         "sample all ages")),
         survival.prior = "diffuse",
...
scenario_3.6.3_results.liz <- map_dfr(scenario_3.6.3_files, read_csv) %>% 
  mutate(sampling.scheme = ifelse(purpose %in% purpose.obj3.6Y, "target YOY",
                                  ifelse(purpose %in% purpose.obj3.6J, "sample all juvenile ages",
                                         "sample all ages")),
         survival.prior = "diffuse",
...
scenario_3.6_results.all_liz <- bind_rows(scenario_3.6.1_results.liz, scenario_3.6.2_results.liz, scenario_3.6.3_results.liz)
...
obj3_results.all_liz <- scenario_3.1_results.all_liz %>% bind_rows(scenario_3.2_results.all_liz, scenario_3.3_results.all_liz, scenario_3.4_results.all_liz, scenario_3.5_results.all_liz, scenario_3.6_results.all_liz) %>% 
  inner_join(psi_all.truth, by = c("sim.psi", "iteration")) %>% 
  mutate(all.truth = ifelse(parameter == "psi", psi.truth, all.truth))
  #dplyr::filter(year == 85) %>% 
...
#---------------------Sample all ages------------------------
#Scenario 4.1 - 5% CV
s4.1.1_all.ages <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.1.1_ageMiss_sample.ALL.ages") %>% 
  mutate(lambda.prior = "diffuse", 
         miss.cv = 0.05)

s4.1.2_all.ages <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.1.2_ageMiss_sample.ALL.ages") %>% 
  mutate(lambda.prior = "tight",
         miss.cv = 0.05)

s4.1.3_all.ages <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.1.3_ageMiss_sample.ALL.ages") %>% 
  mutate(lambda.prior = "none",
         miss.cv = 0.05)

#Scenario 4.2 - 10% CV
s4.2.1_all.ages <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.2.1_ageMiss_sample.ALL.ages") %>% 
  mutate(lambda.prior = "diffuse", 
         miss.cv = 0.10)

s4.2.2_all.ages <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.2.2_ageMiss_sample.ALL.ages") %>% 
  mutate(lambda.prior = "tight",
         miss.cv = 0.10)

s4.2.3_all.ages <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.2.3_ageMiss_sample.ALL.ages") %>% 
  mutate(lambda.prior = "none",
         miss.cv = 0.10)

#Scenario 4.2 - 10% CV
s4.3.1_all.ages <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.3.1_ageMiss_sample.ALL.ages") %>% 
  mutate(lambda.prior = "diffuse", 
         miss.cv = 0.20)

s4.3.2_all.ages <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.3.2_ageMiss_sample.ALL.ages") %>% 
  mutate(lambda.prior = "tight",
         miss.cv = 0.20)

s4.3.3_all.ages <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.3.3_ageMiss_sample.ALL.ages") %>% 
  mutate(lambda.prior = "none",
         miss.cv = 0.20)
...
#Scenario 4.1
s4.1.1_all.juvs <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.1.1_ageMiss_sample.all.juvenile.ages") %>% 
  dplyr::filter(age.x < 12) %>% 
  mutate(lambda.prior = "diffuse",
         miss.cv = 0.05)

s4.1.2_all.juvs <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.1.2_ageMiss_sample.all.juvenile.ages") %>% 
  dplyr::filter(age.x < 12) %>% 
  mutate(lambda.prior = "tight",
         miss.cv = 0.05)

s4.1.3_all.juvs <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.1.3_ageMiss_sample.all.juvenile.ages") %>% 
  dplyr::filter(age.x < 12) %>% 
  mutate(lambda.prior = "none",
         miss.cv = 0.05)

#Scenario 4.2
s4.2.1_all.juvs <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.2.1_ageMiss_sample.all.juvenile.ages") %>% 
  dplyr::filter(age.x < 12) %>% 
  mutate(lambda.prior = "diffuse",
         miss.cv = 0.10)

s4.2.2_all.juvs <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.2.2_ageMiss_sample.all.juvenile.ages") %>% 
  dplyr::filter(age.x < 12) %>% 
  mutate(lambda.prior = "tight",
         miss.cv = 0.10)

s4.2.3_all.juvs <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.2.3_ageMiss_sample.all.juvenile.ages") %>% 
  dplyr::filter(age.x < 12) %>% 
  mutate(lambda.prior = "none",
         miss.cv = 0.10)

#Scenario 4.3 - 20% cv
s4.3.1_all.juvs <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.3.1_ageMiss_sample.all.juvenile.ages") %>% 
  dplyr::filter(age.x < 12) %>% 
  mutate(lambda.prior = "diffuse",
         miss.cv = 0.20)

s4.3.2_all.juvs <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.3.2_ageMiss_sample.all.juvenile.ages") %>% 
  dplyr::filter(age.x < 12) %>% 
  mutate(lambda.prior = "tight",
         miss.cv = 0.20)

s4.3.3_all.juvs <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.3.3_ageMiss_sample.all.juvenile.ages") %>% 
  dplyr::filter(age.x < 12) %>% 
  mutate(lambda.prior = "none",
         miss.cv = 0.20)
...
#-------------------------Target YOY-----------------------------
#Scenario 4.1
s4.1.1_target.YOY <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.1.1_ageMiss_target.YOY") %>% 
  dplyr::filter(age.x == 0) %>% 
  mutate(lambda.prior = "diffuse",
         miss.cv = 0.05)

s4.1.2_target.YOY <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.1.2_ageMiss_target.YOY") %>% 
  dplyr::filter(age.x == 0) %>% 
  mutate(lambda.prior = "tight",
         miss.cv = 0.05)

s4.1.3_target.YOY <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.1.3_ageMiss_target.YOY") %>% 
  dplyr::filter(age.x == 0) %>% 
  mutate(lambda.prior = "none",
         miss.cv = 0.05)

#Scenario 4.2
s4.2.1_target.YOY <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.2.1_ageMiss_target.YOY") %>% 
  dplyr::filter(age.x == 0) %>% 
  mutate(lambda.prior = "diffuse",
         miss.cv = 0.10)

s4.2.2_target.YOY <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.2.2_ageMiss_target.YOY") %>% 
  dplyr::filter(age.x == 0) %>% 
  mutate(lambda.prior = "tight",
         miss.cv = 0.10)

s4.2.3_target.YOY <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.2.3_ageMiss_target.YOY") %>% 
  dplyr::filter(age.x == 0) %>% 
  mutate(lambda.prior = "none",
         miss.cv = 0.10)

#Scenario 4.3 - 20% CV
s4.3.1_target.YOY <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.3.1_ageMiss_target.YOY") %>% 
  dplyr::filter(age.x == 0) %>% 
  mutate(lambda.prior = "diffuse",
         miss.cv = 0.20)

s4.3.2_target.YOY <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.3.2_ageMiss_target.YOY") %>% 
  dplyr::filter(age.x == 0) %>% 
  mutate(lambda.prior = "tight",
         miss.cv = 0.20)

s4.3.3_target.YOY <- readRDS(file = "G://My Drive/Personal_Drive/R/CKMR/Objective.4_aging_error/Model.results/liz_model/samples/samples.missassigned_24Sep2022_Seeds2022.04.15_scenario_4.3.3_ageMiss_target.YOY") %>% 
  dplyr::filter(age.x == 0) %>% 
  mutate(lambda.prior = "none",
         miss.cv = 0.20)
