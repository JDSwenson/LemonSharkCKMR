...
annual.scenarios <- c("scenario_3.1.1", "scenario_3.2.1", "scenario_3.3.1", "scenario_3.4.1", "scenario_3.5.1", "scenario_3.6.1")

multiennial.scenarios <- c("scenario_3.1.2", "scenario_3.2.2", "scenario_3.3.2", "scenario_3.4.2", "scenario_3.5.2", "scenario_3.6.2")
...
obj3_results <- bind_rows(obj3_target.YOY_results, obj3_sample.all.juveniles_results, obj3_sample.ALL.ages_results) %>% mutate(model = ifelse(scenario %in% annual.scenarios, "annual", "multiennial")) %>% 
  mutate(popsim.psi = ifelse(scenario == "scenario_3.1.1" | scenario == "scenario_3.1.2", 1, 
                             ...
                             ifelse(scenario == "scenario_3.4.1" | scenario == "scenario_3.4.2", 0.5,
                              ifelse(scenario == "scenario_3.6.1" | scenario == "scenario_3.6.2", "1*", 1)))))) %>% 
