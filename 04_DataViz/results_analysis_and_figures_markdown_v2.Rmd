...
Need to bring in aunt-niece pairs. Write code that identifies them, then integrate it into estimation code for Objective 1.

Code should be something like:
- Identify full siblings (and count bc Paul wanted this info)
- Identify instances where one of the full sibs had a sampled offspring and a sampled sibling
- Make a dataframe with the birth year of the aunt (oldest indv) and niece (youngest indv) and add to the pairwise comparison matrix as positive half-sibs
- Can then further try excluding based on age-related parameters
...
#### NEED TO PAUSE HERE 8/18/2023 16:12
