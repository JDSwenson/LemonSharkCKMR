...
PopSim.breeding.schedule <- "biennial.breeding_psi0.5" #Can be annual.breeding or biennial.breeding
...
script_name <- "scenario_3.3.3_SB_sample.all.juvenile.ages.R" #Copy name of script here
...
purpose <- "scenario_3.5.3_SB_sample.all.juvenile.ages_psi0.5" #For naming output files
