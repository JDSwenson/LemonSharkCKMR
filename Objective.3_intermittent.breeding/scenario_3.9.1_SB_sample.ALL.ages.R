...
purpose <- "scenario_3.9.1_SB_sample.ALL.ages_psi0.5_fixed" #For naming output files
...
#If we only want to use one type of relationship, we'll filter here
    ...
    #Define JAGS data and model, and run the MCMC engine
      set.seed(rseed)
      source("Objective.3_intermittent.breeding/functions/obj3_runJags_HSPO_noLam_fixPsi.R")
