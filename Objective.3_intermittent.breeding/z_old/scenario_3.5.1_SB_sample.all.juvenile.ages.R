...
script_name <- "scenario_3.3.1_SB_sample.all.juvenile.ages.R" #Copy name of script here
...
purpose <- "scenario_3.5.1_SB_sample.all.juvenile.ages_psi0.5" #For naming output files
