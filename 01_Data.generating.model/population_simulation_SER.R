...
temp_location <- "G:/My Drive/Personal_Drive/R/CKMR/Population.simulations/SER"
output.location <- "G:/My Drive/Personal_Drive/R/CKMR/Population.simulations/SER"
...
init.adult.pop.size <- 3000 # CHANGED FROM 3000; Initial adult population size
...
num.mates <- c(1:2) #1  #c(1:3) #vector of potential number of mates per mating
...
#--------------------- Sampling parameters ---------------------
sample.years <- c(n_yrs - c(12:0)) #For four years of sampling
sample.size <- 50
