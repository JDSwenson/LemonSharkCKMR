...
#  results$Relative_bias <- round(((results$N_est - results$Truth)/results$Truth)*100,1)
  ...
  write.table(results, file = paste0("/home/js16a/R/working_directory/CKMR_simulations/results/Leslie_null_", n_samples, "_samples_01.18.2021.csv"), sep=",", dec=".", qmethod="double", row.names=FALSE)
}