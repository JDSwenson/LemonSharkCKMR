...
script_name <- "scenario_2.1_lambda.extreme_sample.all.juvenile.ages.R" #Copy name of script here
...
question3 <- ""
purpose <- "scenario_2.1_lambda.extreme_sample.all.juvenile.ages" #For naming output files
