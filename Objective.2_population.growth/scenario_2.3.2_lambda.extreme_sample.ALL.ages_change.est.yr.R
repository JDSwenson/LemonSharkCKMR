...
script_name <- "scenario_2.3.2_lambda.extreme_sample.ALL.ages_change.est.yr.R" #Copy name of script here
...
purpose <- "scenario_2.3.2_lambda.extreme_sample.ALL.ages_change.est.yr" #For naming output files
