...
script_name <- "scenario_2.3.1_lambda.trial_sample.ALL.ages_change.est.yr_2.R" #Copy name of script here
...
purpose <- "scenario_2.3.1_lambda.trial_sample.ALL.ages_change.est.yr_2" #For naming output files
