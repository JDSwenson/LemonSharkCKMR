...
script_name <- "Obj2.2.1_lambda.trial_Target.YOY_stablePopSimLambda.R" #Copy name of script here
...
question3 <- ""
purpose <- "Obj2.2.1_lambda.trial_Target.YOY_stablePopSimLambda" #For naming output files
