...
script_name <- "scenario_2.2.1_lambda.trial_sample.ALL.ages_change.est.yr.R" #Copy name of script here
...
purpose <- "scenario_2.2.1_lambda.trial_sample.ALL.ages_change.est.yr" #For naming output files
