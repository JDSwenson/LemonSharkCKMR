...
script_name <- "Obj2.1_lambda.trial_sample.all.juvenile.ages.R" #Copy name of script here
...
question3 <- ""
purpose <- "Obj2.1_lambda.trial_sample.all.juvenile.ages" #For naming output files
