...
script_name <- "Obj2.2.2_lambda.trial_sample.all.juvenile.ages_change.est.yr.R" #Copy name of script here
...
purpose <- "Obj2.2.2_lambda.trial_sample.all.juvenile.ages_change.est.yr" #For naming output files
