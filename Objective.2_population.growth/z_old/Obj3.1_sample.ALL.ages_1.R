...
script_name <- "Obj3.1_sample.ALL.ages_1.R" #Copy name of script here
...
purpose <- "Obj3.1_sample.ALL.ages_1" #For naming output files
...
s <- samples.df %>% group_by(age.x) %>% summarize(n()) #Check that correct age classes were sampled
