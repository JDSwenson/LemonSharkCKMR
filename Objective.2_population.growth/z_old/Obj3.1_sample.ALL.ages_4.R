...
script_name <- "Obj3.1_sample.ALL.ages_4.R" #Copy name of script here
...
purpose <- "Obj3.1_sample.ALL.ages_4" #For naming output files
...
samples.df <- readRDS(file = paste0("./output/Population.simulations/sample.info_", date.of.PopSim, "_", inSeeds, "_", PopSim.lambda, "_", Sampling.scheme)) %>% 
...
#If we only want to use one type of relationship, we'll filter here
    ...
    set.seed(rseed)
    source("Objective.3_life_history_sensitivity/functions/Obj3.1_run.JAGS_HS.PO.R")
