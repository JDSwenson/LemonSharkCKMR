...
script_name <- "Obj3.1_sample.all.juvenile.ages_5.R" #Copy name of script here
...
question3 <- "Part 5 of lambda trials; sample all juvenile ages"
purpose <- "Obj3.1_sample.all.juvenile.ages_5" #For naming output files
...
for(lam in 1:nrow(lambda.split.5)){
  
  lambda.trial <- lambda.split.5[lam, ]
