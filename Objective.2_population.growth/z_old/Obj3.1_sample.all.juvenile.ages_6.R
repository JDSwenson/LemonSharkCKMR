...
script_name <- "Obj3.1_sample.all.juvenile.ages_6.R" #Copy name of script here
...
question3 <- "Part 6 of lambda trials; sample all juvenile ages"
purpose <- "Obj3.1_sample.all.juvenile.ages_6" #For naming output files
...
for(lam in 1:nrow(lambda.split.6)){
  
  lambda.trial <- lambda.split.6[lam, ]
