...
script_name <- "Obj3.1_sample.all.juvenile.ages_4.R" #Copy name of script here
...
question3 <- "Part 4 of lambda trials; sample all juvenile ages"
purpose <- "Obj3.1_sample.all.juvenile.ages_4" #For naming output files
...
for(lam in 1:nrow(lambda.split.4)){
  
  lambda.trial <- lambda.split.4[lam, ]
