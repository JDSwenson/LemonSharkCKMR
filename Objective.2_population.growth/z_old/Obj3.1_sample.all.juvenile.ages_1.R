...
script_name <- "Obj3.1_sample.all.juvenile.ages_1.R" #Copy name of script here
...
question3 <- "Part 1 of lambda trials; sample all juvenile ages"
purpose <- "Obj3.1_sample.all.juvenile.ages_1" #For naming output files
...
for(lam in 1:nrow(lambda.split.1)){
  
  lambda.trial <- lambda.split.1[lam, ]
