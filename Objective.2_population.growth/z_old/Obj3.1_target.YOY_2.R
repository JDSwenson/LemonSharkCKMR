...
script_name <- "Obj3.1_target.YOY_2.R" #Copy name of script here
...
question3 <- "Part 2 of lambda trials; target YOY"
purpose <- "Obj3.1_target.YOY_2" #For naming output files
