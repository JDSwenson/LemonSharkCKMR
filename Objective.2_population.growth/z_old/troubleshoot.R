...
#Split above dataframe so I can loop through over two different scripts
...
#----------------Set G://My Drive/Personal_Drive/R/CKMR file locations ------------------------------
temp_location <- "~/R/working_directory/temp_results/"
MCMC_location <- "G://My Drive/Personal_Drive/R/CKMR/Objective.3_life_history_sensitivity/Model.G://My Drive/Personal_Drive/R/CKMR/"
...
question3 <- "Part 1 of lambda trials; target YOY"
purpose <- "Obj3.1_target.YOY_1" #For naming G://My Drive/Personal_Drive/R/CKMR files
...
for(lam in 25:nrow(lambda.split.1)){
...
#Start iterations
 for(iter in 1:iterations) {
   ...
   for(s in 1:length(sample.sizes)){
    ...
    PO.samps.list <- filter1.out[[1]] #G://My Drive/Personal_Drive/R/CKMR is a list where each list element corresponds to the offspring birth year and contains the potential parents and offspring for that year.
    HS.samps.df <- filter1.out[[2]] #G://My Drive/Personal_Drive/R/CKMR is just the dataframe of samples but filtered for full siblings
    ...
    #Save G://My Drive/Personal_Drive/R/CKMR as different dataframes; includes both HS and PO relationships (but can filter below)
...
#If we only want to use one type of relationship, we'll filter here
  ...
  #-----------------Save G://My Drive/Personal_Drive/R/CKMR files iteratively--------------------
   ...
   # 
   #    #Model G://My Drive/Personal_Drive/R/CKMR for diagnostics
...
#Median relative bias by sample size
 ...
 #-----------------------------Save major G://My Drive/Personal_Drive/R/CKMR files---------------------------------------------
