...
script_name <- "Obj3.1_sample.all.juvenile.ages_3.R" #Copy name of script here
...
question3 <- "Part 3 of lambda trials; sample all juvenile ages"
purpose <- "Obj3.1_sample.all.juvenile.ages_3" #For naming output files
...
for(lam in 1:nrow(lambda.split.3)){
  
  lambda.trial <- lambda.split.3[lam, ]
