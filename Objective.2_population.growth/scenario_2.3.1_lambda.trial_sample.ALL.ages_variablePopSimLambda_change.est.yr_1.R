...
script_name <- "scenario_2.3.1_lambda.trial_sample.ALL.ages_change.est.yr_1.R" #Copy name of script here
...
purpose <- "scenario_2.3.1_lambda.trial_sample.ALL.ages_change.est.yr_1" #For naming output files
...
(iterations <- max(samples.df$iteration))/2
