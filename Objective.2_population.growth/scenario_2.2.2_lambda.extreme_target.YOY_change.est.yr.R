...
script_name <- "scenario_2.2.2_lambda.extreme_target.YOY_change.est.yr.R" #Copy name of script here
...
purpose <- "scenario_2.2.2_lambda.extreme_target.YOY_change.est.yr" #For naming output files
