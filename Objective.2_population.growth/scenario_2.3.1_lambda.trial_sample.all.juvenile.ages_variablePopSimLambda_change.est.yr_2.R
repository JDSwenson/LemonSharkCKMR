...
script_name <- "scenario_2.3.1_lambda.trial_sample.all.juvenile.ages_change.est.yr.R" #Copy name of script here
...
purpose <- "scenario_2.3.1_lambda.trial_sample.all.juvenile.ages_change.est.yr" #For naming output files
