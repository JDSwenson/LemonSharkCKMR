...
```{r echo = FALSE}
#null model results
IBS.null_Lemon_new <- Sys.glob("~/R/R_working_dir/LemonSharkCKMR_GitHub/02_IBS/fishSim_model_validation/results/z_old/new_model/*05.10.2021.csv")
...
IBS.null_Lemon_old <- Sys.glob("~/R/R_working_dir/LemonSharkCKMR_GitHub/02_IBS/fishSim_model_validation/results/pre_vs_post-census/sex-specific_capture_before_mort/*05.11.2021.csv")
...
```{r}
#null model results
IBS.null_Lemon_b4_mort <- Sys.glob("~/R/R_working_dir/LemonSharkCKMR_GitHub/02_IBS/fishSim_model_validation/results/pre_vs_post-census/sex-specific_capture_before_mort/*05.11.2021.csv")
IBS.null_Lemon_b4_mort.df <- sapply(IBS.null_Lemon_b4_mort, read_csv, simplify=FALSE) %>% 
bind_rows() #%>% 
  #drop_na()

IBS.null_Lemon_after_mort <- Sys.glob("~/R/R_working_dir/LemonSharkCKMR_GitHub/02_IBS/fishSim_model_validation/results/pre_vs_post-census/sex-specific_capture_after_mort/*05.11.2021.csv")
...
```{r}
#null model results
IBS.null_Lemon_6yrs <- Sys.glob("~/R/R_working_dir/LemonSharkCKMR_GitHub/02_IBS/fishSim_model_validation/results/length_of_sampling/six_year_sampling/*05.12.2021.csv")
IBS.null_Lemon_6yrs.df <- sapply(IBS.null_Lemon_6yrs, read_csv, simplify=FALSE) %>% 
bind_rows() %>% 
  mutate(Sex = factor(Sex, levels = c("M", "F", "All")))

IBS.null_Lemon_10yrs <- Sys.glob("~/R/R_working_dir/LemonSharkCKMR_GitHub/02_IBS/fishSim_model_validation/results/length_of_sampling/ten_year_sampling/*05.12.2021.csv")
...
```{r}
#null model results
IBS.null_Lemon <- Sys.glob("~/R/R_working_dir/LemonSharkCKMR_GitHub/02_IBS/fishSim_model_validation/results/z_old/new_model/*05.10.2021.csv")
