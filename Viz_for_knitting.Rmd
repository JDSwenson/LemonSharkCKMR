...
```{r}
#optimx
IBS.null_Lemon_optimx.df <- read_csv("~/R/R_working_dir/CKMR/LemonSharkCKMR_GitHub/02_IBS/Dovi_IBS_model_validation/Lemon_Sharks/results/testing/Dovi_AvgN_rmvTry_06.09.2021_optimx.csv") %>% 
  mutate(Sex = factor(Sex, levels = c("M", "F", "All")))


#nlminb
IBS.null_Lemon_nlminb.df <- read_csv("~/R/R_working_dir/CKMR/LemonSharkCKMR_GitHub/02_IBS/Dovi_IBS_model_validation/Lemon_Sharks/results/testing/Dovi_AvgN_rmvTry_06.09.2021_nlminb.csv") %>% 
  mutate(Sex = factor(Sex, levels = c("M", "F", "All")))
