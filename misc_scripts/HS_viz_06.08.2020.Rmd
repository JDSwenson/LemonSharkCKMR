...
setwd("~/R/R_working_dir/CKMR/Results/time_series") #For HP laptop
```

Null model simulations with moderate population size (5000) using fishSim.
...
```{r}
fs_hs <- read.csv("fishSim_HS_time_series_null_400samps_06.22.2020.csv", header=TRUE)
head(fs_hs)
