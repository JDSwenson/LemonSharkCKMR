...
#--------------------- Scenario 3.1 ---------------------------------#
#Objective 3.1
scenario_3.1.1_files <- list.files(path = paste0(objective_3_results_location, "naive_model/"),
                            recursive = FALSE,
...
scenario_3.1.2_files <- list.files(path = paste0(objective_3_results_location, "naive_model/"),
                            recursive = FALSE,
...
scenario_3.1.3_files <- list.files(path = paste0(objective_3_results_location, "naive_model/"),
                            recursive = FALSE,
