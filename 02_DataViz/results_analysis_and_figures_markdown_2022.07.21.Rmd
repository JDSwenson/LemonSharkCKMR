...
plot.colors.fig2 <- c("lightslateblue", "lightblue1")
...
#Plot comparisons
source(file = "~/R/working_directory/LemonSharkCKMR/02_DataViz/functions/Truth_comps_samples_analysis.R")
...
fig2.d <- obj2_results %>% dplyr::filter(parameter %in% c("lambda", "survival"),
                                         population.growth == "extreme negative",
                                         lambda.prior == "diffuse") %>% 
  ggplot(aes(x = relative_bias,
             y = est.yr.lab, 
