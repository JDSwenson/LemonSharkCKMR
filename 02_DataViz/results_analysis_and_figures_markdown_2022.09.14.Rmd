...
scales::show_col(plot.colors.fig2ab)
...
plot.colors.fig2c <- c("red4", "dodgerblue4")
scales::show_col(plot.colors.fig2d)

(fig2.c <- obj2_lam.results_4viz %>% 
...
#  facet_wrap(~sampling.scheme) +
  #xlim(-100, 200) +
  scale_fill_manual(values = plot.colors.fig2c))
