...
for(samps in 1:4){
  ...
  for(iter in 1:iterations) {
    ...
    mis_vec <- c(seq(-3, 3, by=1)) #misassignment of ages
  ...
  write.table(results, file = paste0("/home/js16a/R/working_directory/CKMR_simulations/results/Leslie.null_", n_samples, ".samples_02.10.2021_ages.correct.csv"), sep=",", dec=".", qmethod="double", row.names=FALSE)
}
