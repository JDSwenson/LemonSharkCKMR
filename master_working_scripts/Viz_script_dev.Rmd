...
#null model results
IBS.null_CNR <- Sys.glob("~/R/R_working_dir/CKMR/LemonSharkCKMR_GitHub/IBS_simulations/Dovi_IBS_results/*03.26.2021_N.csv")
...
NullIBS1 <- ggplot(data=IBS.null_results_CNR, aes(x=factor(Samples))) +
