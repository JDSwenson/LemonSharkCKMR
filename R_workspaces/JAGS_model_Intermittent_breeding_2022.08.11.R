#-------------- STEP 1: PREPARE DATA ----------------
mom_comps.all <- readRDS("./R_workspaces/mom.comps_RDS")
dad_comps.all <- readRDS("./R_workspaces/dad.comps_RDS")
...
#    survival.prior.sd = survival.prior.sd,
  ...
  HS.only_model = function(){
    ...
    psi ~ dunif(0.75, 1.0) #Percent of animals breeding bi-ennially; CHANGED from dunif(0,1)
