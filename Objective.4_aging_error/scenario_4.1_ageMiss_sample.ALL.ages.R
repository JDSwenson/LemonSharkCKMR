...
script_name <- "scenario_4.1_ageMiss_sample.ALL.ages.R" #Copy name of script here
...
purpose <- "scenario_4.1_ageMiss_sample.ALL.ages" #For naming output files
 ...
 for(iter in 1:iterations) {
   ...
   for(s in 1:length(sample.sizes)){
     ...
     sample.df_all.info <- samples.df %>% dplyr::filter(iteration == iter, sample.prop == sample.size)
        ...
        ##08/23/2022: Here I'll insert a function to change ages
...
>>>>>>> 6b60cb583579166c970e9ad470091d9575b010d6
####################### End ##############################