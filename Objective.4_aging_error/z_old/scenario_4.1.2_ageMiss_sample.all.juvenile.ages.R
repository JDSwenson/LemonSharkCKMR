...
script_name <- "scenario_4.1.2_ageMiss_sample.all.juvenile.ages.R" #Copy name of script here
...
purpose <- "scenario_4.1.2_ageMiss_sample.all.juvenile.ages" #For naming output files
