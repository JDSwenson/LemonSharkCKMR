...
script_name <- "scenario_4.3.1_ageMiss_sample.ALL.ages.R" #Copy name of script here
...
purpose <- "scenario_4.3.1_ageMiss_sample.ALL.ages" #For naming output files
...
age.cv <- 0.20 #age misassignment cv
