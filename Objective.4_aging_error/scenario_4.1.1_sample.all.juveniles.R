...
#------------------------- Objective 4.1 common settings -------------------------#
jags_file = paste0(jags.model_location, "HS.PO_narrowLambda_annual_model.txt")
date.of.PopSim <- "17Nov2022"

#------------------------- Scenario 4.1.1: Annual breeding; aging error 5% CV -------------------------
age.cv <- 0.05
mating.periodicity <- 1
PopSim.breeding.schedule <- "annual.breeding" #Can be annual.breeding or biennial.breeding
scenario <- "scenario_4.1.1_5CV" #For naming output files
model <- "annual.model"
jags_params = c("Nf", "Nm", "survival", "lambda") #List the parameters to be estimated
estimated.parameters <- paste0(jags_params, collapse = ",")


#------------------------- Scenario 4.1.2: Biennial breeding; psi = 1; aging error 10% CV -------------------------
# age.cv <- 0.10
#mating.periodicity <- 1
# PopSim.breeding.schedule <- "annual.breeding" #Can be annual.breeding or biennial.breeding
# scenario <- "scenario_4.1.2_10CV" #For naming output files
# model <- "annual.model"
# jags_params = c("Nf", "Nm", "survival", "lambda") #List the parameters to be estimated
# estimated.parameters <- paste0(jags_params, collapse = ",")


#------------------------- Scenario 4.1.3: Biennial breeding; psi = 1; aging error 20% CV -------------------------
# age.cv <- 0.20
# mating.periodicity <- 1
# PopSim.breeding.schedule <- "annual.breeding" #Can be annual.breeding or biennial.breeding
# scenario <- "scenario_4.1.3_20CV" #For naming output files
# model <- "annual.model"
# jags_params = c("Nf", "Nm", "survival", "lambda") #List the parameters to be estimated
# estimated.parameters <- paste0(jags_params, collapse = ",")

#------------------------- Objective 4.2 common settings -------------------------#
#date.of.PopSim <- "22Nov2022"
# jags_file <- paste0(jags.model_location, "HS.only_narrowLambda_Skip_model.txt") #Specify the HS only model as the model for now. If the likelihood should include POPs, then we will override the model when we select the sampling scheme several lines down.

#------------------------- Scenario 4.2.1: Biennial breeding; psi = 1; aging error 5% CV -------------------------
# age.cv <- 0.05
# mating.periodicity <- 2
# PopSim.breeding.schedule <- "biennial.breeding_psi1" #Can be annual.breeding or biennial.breeding
# scenario <- "scenario_4.2.1_5CV" #For naming output files
# model <- "multiennial.model"
# jags_params = c("Nf", "psi", "Nm", "survival", "lambda") #List the parameters to be estimated
# estimated.parameters <- paste0(jags_params, collapse = ",")


#------------------------- Scenario 4.2.2: Biennial breeding; psi = 1; aging error 10% CV -------------------------
# age.cv <- 0.10
#mating.periodicity <- 2
# PopSim.breeding.schedule <- "biennial.breeding_psi1" #Can be annual.breeding or biennial.breeding
# scenario <- "scenario_4.2.2_10CV" #For naming output files
# model <- "multiennial.model"
# jags_params = c("Nf", "psi", "Nm", "survival", "lambda") #List the parameters to be estimated
# estimated.parameters <- paste0(jags_params, collapse = ",")


#------------------------- Scenario 4.2.3: Biennial breeding; psi = 1; aging error 20% CV -------------------------
# age.cv <- 0.20
#mating.periodicity <- 2
# PopSim.breeding.schedule <- "biennial.breeding_psi1" #Can be annual.breeding or biennial.breeding
# scenario <- "scenario_4.2.3_20CV" #For naming output files
# model <- "multiennial.model"
# jags_params = c("Nf", "psi", "Nm", "survival", "lambda") #List the parameters to be estimated
# estimated.parameters <- paste0(jags_params, collapse = ",")
